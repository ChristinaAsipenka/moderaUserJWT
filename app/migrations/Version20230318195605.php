 ...
 */
final class Version20230318195605 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE feedback (id INT NOT NULL, owner_id INT NOT NULL, rate INT DEFAULT NULL, feedback_text VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
