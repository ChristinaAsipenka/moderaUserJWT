 ...
 */
final class Version20230319104607 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE feedback_type (id INT NOT NULL, feedback_type VARCHAR(50) NOT NULL, PRIMARY KEY(id))');
    }
